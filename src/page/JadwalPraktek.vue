  ...
  data() {
    return {
        DataDokter :[
        {
          ...
          ImageUrl: "http://rsjakarta.co.id/wp-content/uploads/2020/09/triana.jpg",
          ...
          Pengalaman : "Dokter umum di Klinik Duta Jelambar tahun 2003 – 2004  PTT di kabupaten Solok Selatan, Sumatera barat tahun 2004 – 2006  Dokter spesialis Bedah di RS Amanda CIkarang tahun 2012 – 2013",
...
<template>
<CardProfileDokter v-for="(data, index) in this.DataDokter" :data="data" v-bind:key="index"></CardProfileDokter>
</template>
